...
[[TOC]]
http://wackowiki.com/WackoDocDeutsch/Formatierung
http://trac.seagullproject.org/wiki/WikiFormatting
...
||Links|| ""[WikiLink Link Text] or [WikiLink Text] or WikiLink""||[Edgewall Software](http://www.edgewall.com/) [Title Index](/wiki:TitleIndex/) also direct link to ticket or svn possible||
...
### Formatter
For preformating text (e.g. code etc)
see also: http://trac.seagullproject.org/wiki/WikiProcessors

seems like formatters for IRC or email are missing in trac


||php or other code|| ""
    #!php[[BR]]Text[[BR]]}}}""||`[[BR]]#!c[[BR]]int main(int argc, char *argv[])[[BR]]{[[BR]]  printf("Hello World\n");[[BR]]  return 0;[[BR]]}[[BR]]`||
    ...
    http://seagull.phpkitchen.com/docs/wakka.php?wakka=Internal/export.xml
